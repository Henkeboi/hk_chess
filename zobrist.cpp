...
uint64_t Zobrist::new_zobrist_hash(const Board& board_to_hash, const Board& prev_board, const move::Move& last_move, uint64_t prev_zobrist_hash) const {
	switch (board_to_hash.get_raw_board()[last_move.get_to_row()][last_move.get_to_col()]) {
		case (pieces::white | pieces::pawn):
			...
			prev_zobrist_hash ^= _piece_positions_bits[_white_pawn_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::white | pieces::knight):
			prev_zobrist_hash ^= _piece_positions_bits[_white_knight_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_white_knight_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::white | pieces::bishop):
			prev_zobrist_hash ^= _piece_positions_bits[_white_bishop_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_white_bishop_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::white | pieces::rook):
			prev_zobrist_hash ^= _piece_positions_bits[_white_rook_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_white_rook_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::white | pieces::queen):
			prev_zobrist_hash ^= _piece_positions_bits[_white_queen_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_white_queen_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::white | pieces::king):
			prev_zobrist_hash ^= _piece_positions_bits[_white_king_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_white_king_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::black | pieces::pawn):
			prev_zobrist_hash ^= _piece_positions_bits[_black_pawn_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_black_pawn_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::black | pieces::knight):
			prev_zobrist_hash ^= _piece_positions_bits[_black_knight_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_black_knight_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::black | pieces::bishop):
			prev_zobrist_hash ^= _piece_positions_bits[_black_bishop_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_black_bishop_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::black | pieces::rook):
			prev_zobrist_hash ^= _piece_positions_bits[_black_rook_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_black_rook_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::black | pieces::queen):
			prev_zobrist_hash ^= _piece_positions_bits[_black_queen_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_black_queen_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
		case (pieces::black | pieces::king):
			prev_zobrist_hash ^= _piece_positions_bits[_black_king_index][last_move.get_from_row()][last_move.get_from_col()];
			prev_zobrist_hash ^= _piece_positions_bits[_black_king_index][last_move.get_to_row()][last_move.get_to_col()];
			break;
	}
